...
int main()
{
		...
		cout << "output in double type:" <<setprecision (4) <<static_cast<short>(testUnit) << endl;
		cout << "output in Hex type:" <<hex<<testUnit << endl;
		cout << "output in Oct type:" << oct << testUnit << endl;
